...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        taskAdapter = new ItemAdapter(this, tasks);
        ...
        Cursor curs = dbm.getInformation(dbm);
        if( curs != null && curs.moveToFirst() ){
            curs.moveToFirst();

            do {
                tasks.add(new Item(curs.getString(0), curs.getInt(1), new Date()));
        ...
        builder.setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (!text.trim().equals("")) {
                    ...
                    dbm.putInformation(dbm, text);

                    // Create task object and put it "on view".
                    Cursor curs = dbm.getInformation(dbm);
                    curs.moveToLast();
                    int task_id = curs.getInt(1);


                    taskAdapter.add(new Item(text, task_id, date));
        ...
        if (!isCall) {
            ...
            builder.setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    dbm.deleteTask(dbm, tasks.get(indexToDelete).getId());
